...
% I ADDED THIS FILE MANUALLY TO MY MATCONVNET/MATLAB FOLDER
if exist('vl_tshow.m', 'file') == 2
figure(3) ; vl_tshow(net.layers{1}.weights{1}) ; title('Conv1 filters') ;
figure(4) ; vl_tshow(net.layers{4}.weights{1}) ; title('Conv2 filters') ;
figure(5) ; vl_tshow(net.layers{7}.weights{1}) ; title('Conv3 filters') ;
figure(6) ; vl_tshow(net.layers{10}.weights{1}) ; title('Conv4 filters') ;
end
